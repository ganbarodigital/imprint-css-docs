...
<div class="imprint-callout --imprint-primary --shiki-numbered --standout">
```html
...
<Callout icon="bug">
<h4>Does Not Work In Firefox</h4>

At the time of writing, Firefox does not correctly reset the line number counter.

If you've got any `<ol>` tags on your page before your code example, the line numbers in the code example will be wrong.
</Callout>